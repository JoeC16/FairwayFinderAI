          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-gray-50 rounded-2xl border border-gray-200 p-8">
              ...
              <ul className="space-y-2.5 mb-8">
                {["Full AI fitting wizard", "Overall confidence score", "Shot tendency summary", "Category fit indicators"].map((f) => (
            ...
            <div className="bg-brand-900 rounded-2xl border border-brand-800 p-8 relative">
              ...
              <ul className="space-y-2.5 mb-8">
                {[
                  ...
                  <li key={f} className="flex items-center gap-2 text-sm text-white/80">
                    <Check className="h-4 w-4 text-gold-400 shrink-0" />{f}
                  </li>
                ))}
              </ul>
              ...
              <p className="text-center text-white/40 text-xs mt-4">Payment required only after your analysis is complete</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Yes. Golfers can complete a full fitting as guests. Their contact info is captured as a lead for your sales team. The £4.99 report unlock only applies to direct consumer fittings — retailer-embedded widget fittings are always fully unlocked.",
              },
              {
